...
| Field | Description | Required | Default | Validation |
| --- | --- | --- | --- | --- |
| `name` _string_ | Name of the extension/schema | True |  |  |
| `ensure` _[EnsureOption](#ensureoption)_ | Specifies whether an extension/schema should be present or absent in<br />the database. If set to `present`, the extension/schema will be<br />created if it does not exist. If set to `absent`, the<br />extension/schema will be removed if it exists. |  | present | Enum: [present absent] <br /> |
